<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="EditProduct.aspx.cs" Inherits="EtNet_Web.Pages.Product.EditProduct" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        #tags LI
        {
            background: url(../../images/public/tagleft.gif) no-repeat left bottom;
            float: left;
            margin-right: 1px;
        ...
        #tags LI A
        {
            padding-right: 10px;
            padding-left: 10px;
            background: url(../../images/public/tagright.gif) no-repeat right bottom;
            float: left;
            padding-bottom: 0px;
            color: #999;
            line-height: 23px;
        ...
        .tagContent
        {
            ...
            display: none;
            padding-left: 10px;
            background: url(../../images/public/bg.gif) repeat-x;
            padding-bottom: 10px;
            width: auto;
            color: #474747;
            padding-top: 10px;
    ...
    <div id="con">
        <ul id="tags">
            ...
            <li style="float: right; background: none; width: 210px;">
                <asp:ImageButton CssClass="frameBtn" ID="btnAdd" OnClick="btnAdd_Click" OnClientClick="return getHtml();"
                    ImageUrl="../../Images/Button/btn_save.jpg" runat="server" />
            </li>
        </ul>
        <div id="tagContent">
            <div class="tagContent selectTag" id="tagContent0">
                <table id="need">
                    <tr>
                        ...
                        <td>
                            <input type='text' id='txtType' readonly="readonly" runat="server" /><dfn></dfn>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td>
                            <input type='text' id='txtName' runat="server" /><dfn id="msg"></dfn>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea style="resize: none; height: 200px; width: 300px" id="txtMark" runat="server"></textarea><dfn></dfn>
                        </td>
                    </tr>
                </table>
                <%--<div class="border">
                        <ol id="need">
                            ...
                            <li>
                                ...
                                <input type='text' id='txtName' runat="server" /><dfn></dfn></li>
                            <li>
                                <span>
                            ...
                            <li style="border-bottom:none;margin-bottom:20px">
                                <table>
                                    <tr>
                                        ...
                                        <td><textarea style="resize:none;height:50px;width:300px" id="txtMark" runat="server"></textarea><dfn></dfn></td>
                                    </tr>
                                </table>
                            </li>
                        </ol>
            ...
            <div class="tagContent" id="tagContent1">
                <textarea id="txtBrief" cols="20" rows="2" style="width: 100%; height: 280px; visibility: hidden;"
