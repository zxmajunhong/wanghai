...
(function ($) {
    $.fn.editable = function (options) {
        ...
        //
        var button = "<td><a href='#' class='" + opt.editcss + "'><img src='Image/edit.gif' /></a> <a href='#' class='" + opt.delcss + "'>删除</a><a href='#' class='" + opt.onokcss + "'>确定</a> <a href='#' class='" + opt.canclcss + "'>取消</a></td>";
...
//                        $.ajax(){
//                            type:"get",
//                            url:"TargetHandler.ashx?id="+$rid.val()+"&name="$(td).val(),
//                            dataType:"text"
...
//                        };
    ...
    $.fn.editable.defaults = {
        ...
        */
        ...
        oncancel: function () {
            alert("this's default on cancel click event")
        },
        editcss: "edit",
        delcss: "del",
        onokcss: "onok",
