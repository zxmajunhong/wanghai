<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddressListModify.aspx.cs"
    Inherits="Pages.AddressList.AddressListModify" %>
    ...
    <div class="clsbottom">
        ...
        <table class="clsdata">
            ...
            <tr>
             <td>所属部门:</td>
             <td colspan="3">
              <asp:DropDownList runat="server" ID="ddldepart" CssClass="clsdatalist"></asp:DropDownList>        
             </td>            
            </tr>
