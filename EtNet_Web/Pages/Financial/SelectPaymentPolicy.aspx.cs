...
{
    public partial class SelectPaymentPolicy : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //object objWithInvoice = Request.QueryString["withinvoice"];
                if
                (
                ...
                //string withInvoice = objWithInvoice.ToString().Trim();//付款类别，0：无票付款；1：有票付款
        ...
        private void LoadPolicyList(string payer, string payerType, string payFor)
        {
            ...
            whereBuilder.AppendFormat("AND {0}={1}", payerField, payer);
            ...
            RpPolicyList.DataSource = b_payment.GetViewPayment(whereBuilder.ToString(), "", payFor);
