<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentEdit.aspx.cs" Inherits="EtNet_Web.Pages.Financial.PaymentEdit" %>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <table class="dataBox">
                            ...
                            <tbody>
                                <asp:Repeater ID="RpList" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="del">
                                                <a href="javascript:void(0);" onclick='delRow(this);' title='移除项'>
                                                    <img src='../../images/public/filedelete.gif' /></a>
                                            </td>
                                            <td class="pnum">
                                                <%# Eval("orderNum")%>
                                            </td>
                                            ...
                                            <td>
                                                <input class="amount" type="text" datatype="Require" msg="收款金额不能为空" maxvalue='<%# Eval("money","{0:F2}") %>'
                                                    value='<%# Eval("payAmount","{0:F2}") %>' />
                                            </td>
                ...
                <tr>
                    <td colspan="3" style="padding: 0px;">
                        <table id="mytable3" style="text-align: center;" cellspacing="1" class="mytable">
                            <caption style="margin-top: 0px; margin-bottom: 5px;">
                                上次选择的退款信息
                            </caption>
                            <thead>
                        ...
                        <table class="dataBox">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table id="mytable2" runat="server" style="text-align: center;" cellspacing="1" class="mytable">
                                        <thead>
                                            <tr>
                                                <th class="clstitleimg" style="border-right: 1px solid #B9D3EE; width: 10%;">
                                                    操作
                                    ...
                                    <div style="width: 100%; text-align: left;">
                                        <a href="javascript:void(0);" title="" id="selectReturn">
                                            <img alt="" src="../../Images/public/fileadd.gif" />
                                            <span id="selreturntext">选择退款信息</span> </a>
                                    </div>
                                    <table id="mytable4" style="text-align: center; margin-bottom: 20px" cellspacing="1"
                                        class="mytable">
                                        <thead>
                                            <tr>
                                                <th class="clstitleimg" style="border-right: 1px solid #B9D3EE; width: 10%;">
    ...
    <script type="text/javascript">
        ...
        //显示流程图
            ...
            $("#selectPayer").click(function () {
                artDialog.open("SelectCollect.aspx", { width: "620px", height: "430px" }).lock().title("选择收款单位");
            });
        ...
        function getReturnList(listHTML) {
            $("#mytable4 tbody tr:has(input)").remove();
        ...
        function CalcSum() {
            ...
            try {
                ...
                //上次退款金额合计
                $("#mytable3 .amount").each(function () {
                    var value3 = $.trim($(this).val());
                    if (!isNaN(value3) && value3 != "") {
                        returnTotal += parseFloat(value3);
                    }
                });
                //本次退款金额合计
                $("#mytable4 .amount").each(function () {
                    var value4 = $.trim($(this).val());
                    if (!isNaN(value4) && value4 != "") {
                        returnTotal += parseFloat(value4);
                    }
                });
        ...
        function beforeSubmit() {
            ...
            if (Validator.Validate(document.getElementById('form1'), 1)) {
                if ($.trim($("#ddlApproval").val()) == "" || $.trim($("#ddlApproval").val()) == "-1") {
                    ...
                    $("#mytable3 tbody tr:has(input)").each(function () {
                        payReturn += $.trim($(this).find(".pid").text()) + "$"; //订单退款信息明细表id
                    ...
                    $("#mytable4 tbody tr:has(input)").each(function () {
                        payReturn += $.trim($(this).find(".pid").text()) + "$"; //订单退款信息明细表id
                        payReturn += $.trim($(this).find(".pnum").text()) + "$"; //订单编号
                        payReturn += $.trim($(this).find(".shouldAmount").text()) + "$"; //应退金额
                        payReturn += $.trim($(this).find("input").val()) + "@"; //本次退款金额
