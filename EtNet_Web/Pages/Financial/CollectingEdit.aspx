<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollectingEdit.aspx.cs"
    Inherits="EtNet_Web.Pages.Financial.CollectingEdit" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        table#dataBox input, #lblMarker, #lblMarkerDepartment
        {
            border: 0px;
        ...
        table#dataBox input#txtMoney
        {
            width: 172px;
        }
        table#dataBox input#ChkConfirm
        {
            width: auto;
...
<body>
    ...
    <div style="background: url('../../Images/public/title_hover.png') no-repeat; text-align: left;
        height: 25px;">
        <span style="color: #FFFFFF; padding-left: 5px; font-size: 12px; font-weight: bold;
            line-height: 25px">编辑收款登记 </span>
    </div>
    <div class="border">
        <span style="display: block; width: 100%; text-align: right;">
            <asp:ImageButton ID="BtnSubmit" OnClientClick="return Validator.Validate(document.getElementById('form1'), 1);"
                runat="server" ImageUrl="../../images/button/btn_save.jpg" ToolTip="保存数据" OnClick="BtnSubmit_Click" />
                            <asp:ImageButton runat="server" ID="imgbtnback" ImageUrl="../../Images/Button/btn_back.jpg"
                OnClick="imgbtnback_Click" />
        
           <%-- <a href="CollectingList.aspx" title="返回列表">
        ...
        <div style="border: 1px solid #CDC9C9;">
            <table id="dataBox">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDate" dataType="Require" msg="收款时间不能为空" CssClass="Wdate" onFocus="WdatePicker({isShowClear:false,readOnly:true})"
                    ...
                    <td>
                        <asp:TextBox ID="txtMoney" dataType="Require" msg="收款金额不能为空" onBlur="formatMoney(this);"
                            runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" onclick="manualInput();" style="display: inline-block;
                            width: 16px; height: 16px;" title="手动输入">
                            <img alt="手动输入" src="../../Images/public/edit.gif" />
                        </a><a href="javascript:void(0);" onclick="selectCompany();" title="选择">
                ...
                <tr style="height: 20px;">
                    ...
                    <td colspan="5">
                        <textarea id="txtMark" cols="20" rows="2" runat="server"></textarea>
                    </td>
                </tr>
                <tr>
                    <th>
                ...
                <tr>
                    <th>
                        发送消息： <a href="javascript:void(0);" onclick="selectUser();">
                            <img src="../../Images/public/folder_user.gif" alt="" /></a>
                    </th>
                    <td colspan="2" id="userBox">
                    </td>
                    <td colspan="3" id="confirmBox" runat="server" style="padding-left: 30px;">
    ...
    <script type="text/javascript">
        ...
        function selectCompany() {
            artDialog.open("SelectPayerUnit.aspx", { width: "620px", height: "430px" }).lock().title("选择付款单位");
        }
