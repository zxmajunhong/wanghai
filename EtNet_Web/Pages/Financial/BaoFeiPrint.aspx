<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaoFeiPrint.aspx.cs" Inherits="EtNet_Web.Pages.Financial.BaoFeiPrint" %>
    ...
    <div id="printBox">
        ...
        <div class="wrapper" style="margin: 55px 0 0 75px; width: 90%;">
            <div class="buttonBox" style="margin: 55px 0 0 0">
                <a href="javascript:void(0);" onclick="preview();" title="打印">
            ...
            <div class="content">
                ...
                <table class="dataBox lineTable">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="lbltbrq" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldTitle">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:Label ID="lblbxxz" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldTitle">
                        ...
                        <td colspan="3">
                            <asp:Label ID="lblbfhj" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        ...
                        <td colspan="3" id="bank" runat="server">
                            公司名称：中国人民财产保险股份有限公司舟山市分公司<br />
                            开 户 行：市工行营业部<br />
                            账   &nbsp;&nbsp 号：1206020109031001970
                        </td>
                    </tr>
                    <tr style="height: 50px">
                        <td class="fieldTitle">
