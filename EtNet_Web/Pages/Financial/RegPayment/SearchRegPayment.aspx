<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchRegPayment.aspx.cs" Inherits="EtNet_Web.Pages.Financial.RegPayment.SearchRegPayment" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .clsdetailtable tr td
        {
            border: 1px solid #DED6DC;
            height: 24px;
            text-align: center;
        }
        .clsdetailtable tr .sum-title
        {
            text-align: right;
        }
        .invoiceCol
                            ...
                            <tr>
                                <td colspan="6" style="padding: 0px;">
                                    <table class="dataBox lineTable">
                                        ...
                                        <tr>
                                            <td>
                                                <table id="mytable2" style="text-align: center;" cellspacing="1" class="dataBox clsdetailtable">
                                                    <thead>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <table style="text-align:center;" cellspacing="1" class="dataBox clsdetailtable">
                                                    <thead>
                                                        <tr>
                                                            <th class="clstitleimg" style="border-right: 1px solid #B9D3EE; width: 33%">
                                                                订单编号
                                                    ...
                                                    <tbody>
                                                        <asp:Repeater ID="RpReturnList" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td>
                                                                        <a href="javascript:void(0)" onclick="getOrder('<%# getOrderidReturn(Eval("orderRetId")) %>')"><%#Eval("orderNum") %></a>
                                                                    </td>
                                                                    <td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width:200px">
                                    <asp:Label ID="lblIsPay" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="fieldTitle">
                                ...
                                <td style="width:200px">
                                    <asp:Label ID="lblPayer" runat="server" Text=""></asp:Label>
                                </td>
                                <td class="fieldTitle">
                                    支付日期：
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width:200px">
                                    <asp:Label ID="lblHasInvoice" runat="server" Text=""></asp:Label>
                                </td>
                                <td class="fieldTitle">
                                    收到日期：
                                </td>
                                <td style="width:200px">
                                    <asp:Label ID="lblHasInvoiceDate" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="fieldTitle">
                                ...
                                <td colspan="3">
                                    <asp:Label ID="lblpz" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                        </tbody>
                    </table>
