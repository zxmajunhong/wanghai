<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPayInvoice.aspx.cs" Inherits="EtNet_Web.Pages.Financial.RegPayment.SelectPayInvoice" %>
        ...
        <table id="mytable2" style="text-align: center;" cellspacing="1" class="clsdata">
            <thead>
                <tr>
                    ...
                    <th class="clstitleimg" style="border-right:1px solid #B9D3EE;width:200px;">
                        发票号
                    </th>               
            ...
            <tbody id="policyList">
            <asp:Repeater ID="rpInvoiceList" runat="server">
                <ItemTemplate>
                    <tr>
                        <td class="del">
                            <input name="check" type="checkbox" />                        
                        </td>
                        <td><input class="num" readonly="readonly" type="text" value='<%# Eval("invoiceID") %>' /></td>
                        <td><input class="remark" readonly="readonly" type="text" value='<%# Eval("remark") %>' /></td>
                        <td style="display:none;"><input class="id" readonly="readonly" type="text" value='<%# Eval("id") %>' /></td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>  
            </tbody>
