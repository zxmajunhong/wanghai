<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnouncementAdd.aspx.cs" Inherits="EtNet_Web.Pages.Announcement.AnnouncementAdd" %>
     ...
     <div class="clstop">
       <div style=" background-image:url('../../Images/Public/title_hover.png'); background-repeat:no-repeat; height:25px;">
          <table style=" width:100%; height:100%;">
            <tr>
              <td class="toptitletxt">新增部门公告</td>
            </tr>
          </table>
       </div>
