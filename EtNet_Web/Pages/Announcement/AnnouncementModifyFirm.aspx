<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnouncementModifyFirm.aspx.cs" Inherits="EtNet_Web.Pages.Announcement.AnnouncementModifyFirm" %>
     ...
     <div class="clstop">
       <div style=" background-image:url('../../Images/Public/title_hover.png'); background-repeat:no-repeat; height:25px;">
          <table style=" width:100%; height:100%;">
            <tr>
              <td class="toptitletxt">修改公司公告</td>                        
            </tr>
          </table>
       </div>
       ...
       <table class="clsdata">      
         ...
         <tr>
          ...
          <td>
            ...
            <img id="imgseal" title="选取公章"  style=" margin-bottom:-5px;" src="../../Images/Public/picture.png"  alt="选取公章" />
         ...
         <tr>
           <td colspan="3"></td>
           <td>
             <div id="showpicture" runat="server"></div>
           </td>
         </tr>
         <tr>
