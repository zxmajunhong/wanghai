<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FactAddType.aspx.cs" Inherits="EtNet_Web.Pages.Common.FactAddType" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#choose').click(function () {
                ...
                //                cusid.value = $.trim($(this).parent().parent().find('.custypeid').html());
