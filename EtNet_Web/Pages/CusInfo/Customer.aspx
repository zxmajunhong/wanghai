<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="EtNet_Web.Pages.CusInfo.Customer" %>
    ...
    <div class="clsbottom">
        <table class="clssift">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList Width="200px" ID="ddlsalesman" runat="server"></asp:DropDownList>
                </td>
                <td align="right" style="width: 80px;">
                    &nbsp;
                </td>
                            ...
                            <asp:Repeater runat="server" ID="cuslist" OnItemCommand="cuslist_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# pages_cusinfo_customer_aspx.cuspro(Eval("cusPro").ToString()) %>
                                        </td>
                                        <td>
                                            <%# pages_cusinfo_customer_aspx.ifused(Eval("CusType").ToString())%>
                                        </td>
                                        <td>
                                            ...
                                            <asp:ImageButton ID="ImageButton3" title="编辑" AlternateText="编辑" Visible='<%# IsCanEdit(Eval("madefrom")) %>'
                                            ...
                                            <asp:ImageButton ID="ImageButton7" runat="server" CommandName="Delete" CommandArgument='<%# Eval("id") %>'
                                                ImageUrl="~/Images/public/delete.gif" Visible='<%# IsSelf(Eval("madefrom")) %>'
