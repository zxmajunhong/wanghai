<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CusDetial.aspx.cs" Inherits="EtNet_Web.Pages.CusInfo.CusDetial" %>
    ...
    <div class="clsbottom">
        ...
        <div class="content">
            <table class="dataBox lineTable">
                ...
                <tr>
                    <td class="fieldTitle" style="width: 250px;">
                        收款单位代码
                    </td>
                    <td style="width: 20%;">
                ...
                <tr>
                    <td colspan="6" style="text-align: center; background: #F0F0F0;">
                        <span style="font-weight: bold; font-size: 14px;">提成系数</span>
                    </td>
                </tr>
                <tr>
                    <td class="fieldTitle">
                    ...
                    <td>
                        <asp:Label Width="200" ID="lblnewRatio" runat="server"></asp:Label>
                    </td>
                    <td class="fieldTitle">
                        老客户提成系数
                    </td>
                    <td colspan="3">
                        <asp:Label ID="lbloldRatio" Width="200" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="fieldTitle">
        ...
        <table class="clsdata" style="margin-top: 5px;">
            <tr>
                <td style="text-align: center;">
                    <span style="font-weight: bold; font-size: 14px;">营业部信息</span>
                </td>
            </tr>
            <tr>
