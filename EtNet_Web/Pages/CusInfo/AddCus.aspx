<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCus.aspx.cs" Inherits="EtNet_Web.Pages.CusInfo.AddCus" %>
...
<body onload='init();'>
    ...
    <div class="clsbottom">
        <div style="text-align: right">
            <img alt="" id="imgsave" src="../../Images/Button/btn_save.jpg" onclick="return imgsave_onclick()" />
                    ...
                    <td style="padding-right: 20px; padding-left: 20px;">
                        <table id="tablebank" runat="server" cellspacing="1" cellpadding="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div title="删除" class="clsimgdel">&nbsp;</div>
                                </td>
                            </tr>
                        </table>
                    </td>
