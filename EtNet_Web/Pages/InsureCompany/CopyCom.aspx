<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CopyCom.aspx.cs" Inherits="EtNet_Web.Pages.InsureCompany.CopyCom" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .lineTable{border: 1px solid rgb(205, 201, 201);width: 100%;padding: 0;margin: 0;border-collapse: collapse; color: rgb(205, 201, 201);}
        .style1
        {
            height: 20px;
        }
    ...
    <div class="clsbottom">
        <div style="text-align: right; padding-right: 10px;">
         ...
         <!--版本号：20130312-->
           ...
           <div style="margin: 0px 10px 20px 10px; padding-bottom: 5px; border: 1px solid #CDC9C9;">
            <table class="dataBox">
                <tr>
                    <td align="center" colspan="6" style="background: #F0F0F0" class="style1">
                ...
                <tr>
                    ...
                    <td align="left" style="width: 25%;"> 
                       ...
                       <asp:TextBox ID="TxtType" dataType="Require" ReadOnly runat="server" class="clsunderline"></asp:TextBox>
                        &nbsp;<a  class="edittype"><img alt="选择" src="../../Images/public/expand.gif" title="选择类别"/></a>
                             <a class="addtype">
        ...
        <div class="content">
            <table class="dataBox lineTable">
                <tr>
                    <td align="center">
                        <span style="font-weight: bold; font-size: 16px; color:Black">其他联系人</span>
                    </td>
                </tr>
                <tr>
                    <td style="padding-right: 10px; padding-left: 10px; vertical-align: top;">
                        <table id="tablelink" cellspacing="1" cellpadding="1" style="width: 100%; " runat="server">
                            <tr style="font-size: 12px; font-weight: bold;">
                                ...
                                <td class="clstitleimg" style="width:30px;">
                                    操作
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="content">
            <table  class="dataBox lineTable">
                <tr>
                    <td align="center">
                        <span style="font-weight: bold; font-size: 16px; color:Black">其他银行信息</span>
                    </td>
                </tr>
                <tr>
                    <td style="padding-right: 10px; padding-left: 10px; vertical-align: top;">
                    ...
                    <table class="clsdata" style="text-align: left; padding-left: 30px; padding-right: 30px;">
                        ...
                        <tr>
                            ...
                            <td style="width: 300px;">
                                <input type="text" runat="server" id="comCode" class="clsunderline" /><span id="txtshow" runat="server" style="color: Red">*</span>
                            </td>
                            <td style="width: 80px;">
                                是否启用:
                            </td>
                        ...
                        <tr>
                            <td colspan="4" style="padding-right: 10px;">
                                <textarea id="bankremark" runat="server" cols="20" name="S1" rows="1" style="height: 100px;
                                    width: 76%; resize: none;font-size: small;"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4" style="padding-right: 10px;">
