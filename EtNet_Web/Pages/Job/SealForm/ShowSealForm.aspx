<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowSealForm.aspx.cs" Inherits="PJOAUI.View.Job.SealForm.ShowSealForm" %>
...
<body>
    ...
    <div>
           ...
           <tr>
               <td colspan="8" style="background-image: url('../../../Images/Job/win_top.png');
                 ...
                 <span class="titlebtncls">
                   <a href="#" class="editpage"><img src="../../../Images/Common/layoutedit.png" alt="设置" />页面设置</a>
                   <a href="#" class="siftdata"><img src="../../../Images/Job/expand.gif" alt="展开筛选栏" /> 数据筛选 </a>
                   <a class="addapplylink" href="AddSealForm.aspx"><img src="../../../Images/Job/addapply.gif" alt="添加申请" /> 添加申请 </a>
                   <asp:ImageButton runat="server"  ID="imgbtndata"   ImageUrl="~/Images/Job/tablesave.png" onclick="imgbtndata_Click" /> 
            ...
            <tr>
               <td colspan="8" align="right">
                    ...
                    <asp:ImageButton ID="ibtnjobreset" runat="server" 
                        ImageUrl="~/Images/home/btn_reset.jpg" onclick="ibtnjobreset_Click" />
                </td>
            </tr>
           </table>
          </td>
          ...
          <td colspan="8">
              <table style="width: 100%" id="table1" class="sortable">
                      <thead>
                        ...
                        <tbody>
                            <asp:Repeater ID="rptsealform" runat="server" OnItemCommand="rptsealform_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <%# Eval("jobflowcname")%>
                                        ...
                                        <td>
                                            <%# Eval("applicantcname") + "(" + Eval("applicantdepartcname") + ")"%>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <%# Eval("savestatus") %>
                                            <asp:ImageButton ID="ImageButton1" runat="server" Enabled='<%# Eval("savestatus").ToString() == "草稿"?false: true  %>'
                                                CommandName="refresh" CommandArgument='<%# Eval("jobflowid") %>' ImageUrl="~/Images/Job/formfresh.png" AlternateText="刷新" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="ImageButton2" runat="server" CssClass="imgbtnedit" CommandName="edit"
                                                CommandArgument='<%# Eval("jobflowid") %>' ImageUrl="~/Images/Job/edit.gif" AlternateText="编辑"/>
                                            <asp:ImageButton ID="ImageButton3" runat="server" CssClass="imgbtnsearch" Enabled='<%# Eval("savestatus").ToString() == "草稿"?false: true  %>'
                                                CommandName="search" CommandArgument='<%# Eval("jobflowid") %>' ImageUrl="~/Images/Job/person.gif" AlternateText="详细"/>
                                            <asp:ImageButton ID="ImageButton4" runat="server" CssClass="imgbtndel" Enabled='<%# Eval("auditstatus").ToString() =="01"? true :false  %>'
                                                CommandName="del" CommandArgument='<%# Eval("jobflowid") %>' ImageUrl="~/Images/Job/delete.gif" AlternateText="删除" />
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
        ...
        <script src="../../../Scripts/Common/script1.js" type="text/javascript"></script>
        <script type="text/javascript">
