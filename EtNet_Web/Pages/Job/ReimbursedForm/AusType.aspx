<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AusType.aspx.cs" Inherits="EtNet_Web.Pages.Job.ReimbursedForm.AusType" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#choose').click(function () {
                ...
                var id = origin.document.getElementById('hidaustype').value;
