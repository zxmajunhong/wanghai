<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyReimbursedForm.aspx.cs"
    Inherits="EtNet_Web.Pages.Job.ReimbursedForm.ModifyReimbursedForm" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .clsfiledel
        {
            background-image: url('../../../Images/public/delete.gif');
            width: 16px;
            height: 16px;
        ...
        $(function () {
            ...
            $(".clsfiledel").live("click", function () {
                if (confirm('确定删除!')) {
                    ...
                    $.get("../JobFlowHandler.ashx", { sort: 2, fileid: fid }, function (data) {
            ...
            $(".imgadd").click(function () {
                ...
                str += '<td class="clssalse" id=' + depart + '><input type="text"/ id=' + saleman + ' style="text-align: center" value=' + document.getElementById("saleman1").value + '></td>';
            ...
            function checkdetial() {
                ...
                $("#tblprocess input").each(function () {
                    var strnum = $(this).val();
                    // var rg = new RegExp("^(0|[1-9][0-9]*|(0\.[0-9]*[1-9])|([1-9][0-9]*\.[0-9]*[1-9]))$");   
            ...
            function savedetial() {
                debugger;
                var list = "";
                $("#tblprocess tr:gt(0)").each(function () {
                    var txt = "";
            ...
            $("#selectOrder").click(function () {
                artDialog.open('SelectOrder.aspx', { width: '600px' }).lock().title('选择订单');
            });

            //
            function showdialog(departid) {
                var value = document.getElementById('departid').value;
                artDialog.open('Salesman.aspx?depart=' + value, { width: '310px', height: '480px' }).lock().title('选择所属报销人员');
            }
        })
...
<body>
    ...
    <input type="hidden" runat="server" id="hidtyperows" value="2" />
    ...
    <input type="hidden" runat="server" id="hidaustype" value="type1"  />
    ...
    <div class=" clsbottom">
                ...
                <tbody id="orderList">
                    <asp:Repeater ID="rpOrderlist" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td class="del">
                                    <a href="javascript:void(0);" onclick="delRow(this);"><img alt="删除" src="../../../Images/public/filedelete.gif" /> </a>
                                </td>
                                <td class="orderNum">
                                    <%# Eval("orderNum") %>
                                </td>
        ...
        <div style="margin: 0px 10px 20px 10px; padding-bottom: 5px; border: 1px solid #CDC9C9;">
            ...
            <table id="totalnum" cellspacing="1" cellpadding="1">
                <tr style="height:25px">
                    <td style="color:Blue" class="style1">
                        合计:
                    </td>
        ...
        <tr>
        <br />
            <td colspan="5" style="font-size:12px;font-weight:bold" >
              原有附件:
            </td>
        </tr>
        <tr>
