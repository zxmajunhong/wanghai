<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AusFin.aspx.cs" Inherits="EtNet_Web.Pages.Job.ReimbursedForm.AusFin" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#choose').click(function () {
                ...
                var id = origin.document.getElementById('hidausfin').value;
                ...
                var cusid = origin.document.getElementById('HidFinId');
