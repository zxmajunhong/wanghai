...
namespace Pages.Message
{
    public partial class Notice : System.Web.UI.Page
    {
        ...
        //{
        //    this.Repeater1.DataSource = NoticeInfoManager.getNoticeInfoAll();
        ...
        //加载显示
        public static string getNoticeState(string args)
        {
            return args.Equals("0") ? "草稿" : "已发送";
        }
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                EtNet_Models.NoticeInfo notice = NoticeInfoManager.getNoticeInfoById(Convert.ToInt32(id));
