<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AusItemList.aspx.cs" Inherits="EtNet_Web.Pages.AusItem.AusItemList" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#addtxt").click(function () {
                window.location = "AddAusItem.aspx";
            })
            ...
            $("#editpage").click(function () {
                ...
                strmodal += "status=no";
                window.showModalDialog("../Common/PageSearchSet.aspx?pagenum=022&dt=" + new Date().toString(), window.self, strmodal);
            })
                ...
                <td style="vertical-align: top;">
                    <table class="clsdata" cellspacing="1" cellpadding="0">
                        <tr>
                            ...
                            <th class="clstitleimg" style="width: 50%;">
                                类别名称
                            </th>
                            ...
                            <asp:Repeater runat="server" ID="cuslist" OnItemCommand="cuslist_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# two(Eval("zamount").ToString()) %>
                                        </td>
                                        <td>
                                            <%# two(Eval("zhaspay").ToString()) %>
                                        </td>
                                        <td>
                                            <%# canpay(Eval("zamount").ToString(),Eval("zhaspay").ToString()) %>
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="money" CommandName="money" CommandArgument='<%# Eval("itemname") %>'
                                                runat="server">金额预算
                                            </asp:LinkButton>
                                        </td>
                                        <td>
