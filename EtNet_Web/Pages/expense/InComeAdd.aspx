<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InComeAdd.aspx.cs" Inherits="EtNet_Web.Pages.expense.InComeAdd" %>
        ...
        <div style="border:1px solid #CDC9C9;">
            <table id="dataBox">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtSKDate" dataType="Require" msg="收款日期不能为空" CssClass="Wdate" onFocus="WdatePicker({isShowClear:false,readOnly:true})" runat="server"></asp:TextBox>
                    </td>
                    <th>
                        付款单位：
                    </th>
                    <td>
                        <asp:TextBox ID="txtSKUnit"  runat="server" Text=""></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>
