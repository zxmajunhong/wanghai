<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InComeList.aspx.cs" Inherits="EtNet_Web.Pages.expense.InComeList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#editpage").click(function () {
                ...
                strmodal += "status=no";
                window.showModalDialog("../Common/PageSearchSet.aspx?pagenum=035&dt=" + new Date().toString(), window.self, strmodal);
            })
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: right; padding-right: 20px;">
                        ...
                        <a href="InComeAdd.aspx" title="新增" style="text-decoration:none"><span class="topimgtxt" id="addtxt" title="新增">
    ...
    <div class="clsbottom">
        <table class="clssift">
            <tr>
                ...
                <td>
                    <input type="text" id="txtFkUnit" runat="server" class="clsunderline" />
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 80px;">
                ...
                <td>
                    <asp:DropDownList ID ="ddlsktype" CssClass="filterInput" runat="server">
                    </asp:DropDownList>
                </td>
                <td align="right" style="width: 80px;">
                    制单员:
        ...
        <table class="clsdata" cellspacing="1" cellpadding="0">
            ...
            <tbody>
                <asp:Repeater ID="inList" runat="server" OnItemCommand="inList_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            <td>
