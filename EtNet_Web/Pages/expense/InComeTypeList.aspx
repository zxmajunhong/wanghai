<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InComeTypeList.aspx.cs" Inherits="EtNet_Web.Pages.expense.InComeTypeList" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#addtxt").click(function () {
                window.location = "AddIncomeType.aspx";
            })
            //编辑默认设置
            ...
            <tr>
                <td style="vertical-align: top;">
                    <table class="clsdata" cellspacing="1" cellpadding="0">
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="typeList" OnItemCommand="typeList_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td>
