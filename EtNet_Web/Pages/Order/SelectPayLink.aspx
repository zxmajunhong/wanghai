<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPayLink.aspx.cs"
    Inherits="EtNet_Web.Pages.Order.SelectPayLink" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#saveBack').click(function () {
                ...
                //联系人名称
                var linkvalue = document.getElementById('hidlinkname').value;
                var link = origin.document.getElementById(linkvalue);
                link.value = $.trim($('tr.selected').find('#linkname').html());
