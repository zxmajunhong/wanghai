<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileOrderList.aspx.cs" Inherits="EtNet_Web.Pages.Order.FileOrderList" %>
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="cuslist" OnItemCommand="cuslist_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <a href='OrderDetial.aspx?id=<%#Eval("id") %>' target="_blank">
                                             <%#Eval("iscancel").ToString() == "Y"?"<del>"+Eval("orderNum")+"</del>":Eval("orderNum") %></a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:ImageButton ID="ibtFile" title="取消存档" runat="server" CommandName="File" CommandArgument='<%#Eval("id") %>'
