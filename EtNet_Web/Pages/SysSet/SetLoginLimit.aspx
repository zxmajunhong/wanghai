<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetLoginLimit.aspx.cs" Inherits="Pages.SysSet.SetLoginLimit" %>
<%@ Register Src="UserLimit.ascx" TagName="UserLimit" TagPrefix="uc1" %>
        ...
        <table style="width:100%;">
            <tr>
                <td style="text-align: center" colspan="3">
                    <strong><span style="font-size: large">用 户 权 限 分 配</span></strong>
                    <br />
            ...
            <tr>
                <td colspan="3">
                    <asp:PlaceHolder ID="phUserDistribute" runat="server"></asp:PlaceHolder>
                </td>
            </tr>
            <tr>
                <td>
                    当前用户：
                    <asp:Label ID="lblCurrentUser" runat="server" Font-Bold="True" Width="125px"></asp:Label>
                </td>
                <td>
