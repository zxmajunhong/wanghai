<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EtNet_Web.CMS.Login" %>
...
//                    str += "<tr><td class='tdmsg'> <img src='Images/qh_32.jpg' />";
//                    str += list[i] + "</td></tr>";
//                    $(str).appendTo($("#msg"));
//                    str = "";
//                }
...
//            var setmsg = setInterval(msg, 5000);
...
<body background="images/bg1.jpg" style="background-attachment: fixed; background-repeat: no-repeat">
    <form id="myform" runat="server">
    <div style="background-image: Images/login/bg1.jpg; width: 100%">
        <div id="Layer7" style="background-image: url(../Images/login/login_box.png); background-repeat: no-repeat;">
            <div id="Layer1">
                <table align="left" style="width: 100%;">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtLoginId" runat="server" Width="150px" Text="admin" ReadOnly="true" CssClass="ButtonStyle"></asp:TextBox>
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="Layer8">
                <asp:ImageButton ID="ibtnLogin" runat="server" ImageUrl="../Images/login/btn_denglu.png"
                    OnClick="ibtnLogin_Click" /></div>
        </div>
        <div id="Layer2" style="font-size: 13px; font-weight: normal; line-height:20px; color: #313131;">
        ...
        <div id="Layer5" style="background-image: url(../Images/login/tit_news.png); z-index: 100;
            ...
            <div style="margin-left: 110px; margin-top: 10px;">
                <table id="msg" style="width: 420px; font-size: 12px;">
                </table>
            </div>
        </div>
