<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanysManager.aspx.cs"
    Inherits="EtNet_Web.CMS.Data.CompanysManager" %>
                            ...
                            <asp:Repeater ID="rpCompany" runat="server" OnItemCommand="rpCompany_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# cms_data_companysmanager_aspx.toMadeFrom(Convert.ToInt32(Eval("inputname"))) %>
                                        </td>
                                        <td>
