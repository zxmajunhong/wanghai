<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectOrderReturn.aspx.cs"
    Inherits="EtNet_Web.Pages.Financial.SelectOrderReturn" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#saveBack').click(function () {
                ...
                window.parent.getReturnList(listHTML);
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="amount" style="color: Red" readonly="readonly" datatype="Require" msg="金额不能为空"
                                    maxvalue='<%# GetCanAmount(Eval("money"), Eval("orderRetID")) %>' value='<%# GetCanAmount(Eval("money"), Eval("orderRetID")) %>'
                                    type="text" />
                            </td>
                            <td class="nouse" style="color: Green;">
                                <%# GetHasAmount(Eval("orderRetID"))%>
                            </td>
