<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FundsAllocation.aspx.cs" Inherits="EtNet_Web.Pages.Financial.FundsAllocation" %>
        ...
        <table class="clsdata" cellpadding="0" cellspacing="1">
            ...
            <tbody>
                <asp:Repeater ID="RpList" runat="server" onitemcommand="RpList_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            <td><%# Eval("receiptStatusCode") == null ? "<font color='red'>未认领</font>" : (Eval("receiptStatusCode").ToString()=="0"?"<font color='red'>未认领</font>":"已认领")%></td>
                            ...
                            <td><%# Eval("cname") == DBNull.Value ? "暂无" : Eval("cname").ToString() %></td>
                            <td><%# Eval("receiptNum") %></td>
                            <td><%# Eval("receiptDate","{0:d}") %></td>
                            ...
                            <td style="text-align:left;padding-left:2px;">
                                <a href='<%# "Collecting.aspx?id="+Eval("id")+"&returnUrl=FundsAllocation.aspx" %>' title="预览">
                                    <img src="../../Images/public/searchform.png" alt="预览" />
                                </a>
                                <a href='<%# "FundsAllocation/Step1.aspx?id="+Eval("id") %>' visible='<%# Eval("receiptStatusCode").ToString()=="0" %>' title="认领" runat="server">
                                    <img src="../../Images/icons/mtgrsp-accept.gif" alt="认领" />
                                </a>
                                <asp:ImageButton ID="BtnCancel" ToolTip="取消认领" CommandName="CANCEL" CommandArgument='<%# Eval("id") %>' ImageUrl="~/Images/icons/mtgrsp-decline.gif" visible='<%# Eval("receiptStatusCode").ToString()!="0" %>' runat="server"
                                OnClientClick="return window.confirm('确定要取消认领吗?');" ></asp:ImageButton>
                                <asp:ImageButton  ID="BtnCancelConfirm" runat="server" OnClientClick="return window.confirm('确定要取消确认吗?');"
                                    ...
                                    Visible='<%# Eval("receiptStatusCode").ToString()=="2" %>'></asp:ImageButton>
                                <asp:ImageButton ID="ImageButton1" ToolTip="编辑" CommandName="EDIT" CommandArgument='<%# Eval("id") %>' ImageUrl="../../Images/public/edit.gif" visible='<%# Eval("receiptStatusCode").ToString()=="1" %>' runat="server"
                                    ></asp:ImageButton>
