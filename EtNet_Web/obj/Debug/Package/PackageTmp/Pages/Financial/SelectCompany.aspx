<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectCompany.aspx.cs" Inherits="EtNet_Web.Pages.Financial.SelectCompany" %>
    ...
    <div class="clsbottom">
        <table class="clssift">
            <tr>
                ...
                <td>
                    <input type="text" runat="server" id="shortname" class="clsunderline" />
                </td>
                <td style="width: 60px;">
                    单位全称:
                </td>
                <td>
                    <input type="text" runat="server" id="name" class="clsunderline" />
                </td>
            </tr>
            <tr>
                <td style="width: 60px;">
