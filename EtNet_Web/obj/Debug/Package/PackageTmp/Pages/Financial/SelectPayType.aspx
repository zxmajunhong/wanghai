<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectPayType.aspx.cs" Inherits="EtNet_Web.Pages.Financial.SelectPayType" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#choose').click(function () {
                ...
                var paytypeid = origin.document.getElementById('hidPayerType'); //存储类别id
                var typename = origin.document.getElementById('txtPayType'); //类别名称
                paytypeid.value = $.trim($('tr.selected').find('.paytypeid').html());
