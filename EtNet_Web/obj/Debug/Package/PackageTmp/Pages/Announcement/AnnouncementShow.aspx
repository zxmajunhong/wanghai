<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnouncementShow.aspx.cs" Inherits="EtNet_Web.Pages.Announcement.AnnouncementShow" %>
...
<head runat="server">
    ...
    <style type="text/css">
      ...
      .topimgtxt{font-size:12px;
       ...
       .buttonStyle{ background:url('../../Images/Common/buticon.gif');border:0; height:22px; width:64px;  }
    </style>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#editpage").click(function () {
                ...
                strmodal += "status=no";
                window.showModalDialog("../Common/PageSearchSet.aspx?pagenum=005&dt=" + new Date().toString(), window.self, strmodal);
            })
     ...
     <div class="clsbottom">
        ...
        <table class="clsdata" cellspacing="1" cellpadding="0">
          <tr>
            ...
            <td class="clstitleimg" style=" width:80px;">是否可见</td>
            <td class="clstitleimg" style=" width:60px;">状态</td>
            <td class="clstitleimg" style=" width:120px;">操作</td>
          </tr>
          <tbody>
              ...
              <ItemTemplate>
                <tr>
                  ...
                  <td>
                    ...
                    <asp:ImageButton  runat="server" title="发布" CommandName="publish" CommandArgument='<%# Eval("id") %>' ImageUrl="~/Images/public/itemgo.png"/>
