<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartMoneyList.aspx.cs"
    Inherits="EtNet_Web.Pages.AusItem.DepartMoneyList" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#addtxt").click(function () {
                var value = document.getElementById('hiditem').value;
                window.location = "AddMoney.aspx?itemname=" + value;
            })
            ...
            $("#editpage").click(function () {
                ...
                strmodal += "status=no";
                window.showModalDialog("../Common/PageSearchSet.aspx?pagenum=030&dt=" + new Date().toString(), window.self, strmodal);
            })
            ...
            <tr>
                <td style="vertical-align: top;">
                    <table class="clsdata" cellspacing="1" cellpadding="0">
                        ...
                        <tbody>
                            <asp:Repeater runat="server" ID="moneylist" OnItemCommand="moneylist_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <%# two(Eval("amount").ToString()) %>
                                        </td>
                                        <td>
                                            <%# two(Eval("haspay").ToString()) %>
                                        </td>
                                        <td>
                                            <%# canpay(Eval("amount").ToString(),Eval("haspay").ToString()) %>
                                        </td>
                                        <td>
                                            <%# Eval("years") %>
                                        </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="zzje"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label runat="server" ID="zyzf"></asp:Label>
                                </td>
                                <td>
                                    <asp:Label runat="server" ID="zkzf"></asp:Label>
                                </td>
                                <td>
                                    &nbsp;
                                </td>
