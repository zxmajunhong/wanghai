<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollectDetailList.aspx.cs"
    Inherits="EtNet_Web.Pages.Statistical.CollectCount.WebForm2" %>
    ...
    <div class="clsbottom">
        <table class="clssift">
            <tr>
                ...
                <td>
                    <input type="text" id="txtdepartname" runat="server" class="clsunderline" />
                </td>
                <td style="width: 80px; text-align: right;">
                    联系人:
                </td>
                <td>
                    <input type="text" id="txtlinkname" runat="server" class="clsunderline" />
                </td>
            </tr>
            <tr>
                <td style="width: 80px; text-align: right;">
                ...
                <td>
                    <asp:DropDownList ID="ddlCollectStatus" runat="server" Width="200px">
                ...
                <td>
                    <asp:DropDownList ID="ddlCollectMoney" runat="server" Width="200px">
                        <asp:ListItem Text="——请选择——" Value=""></asp:ListItem>
            ...
            <tr>
                <td colspan="6" style="text-align: right;">
                    <asp:ImageButton runat="server" ID="imgbtnsearch" ImageUrl="~/Images/Button/btn_search.jpg"
                        OnClick="imgbtnsearch_Click" Style="height: 21px" />
        ...
        <table class="clsdata" cellspacing="1" cellpadding="0">
                ...
                <asp:Repeater ID="rptdata" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%--   调用后台方法进行转换    <%# ConvertToShort(Eval("receiptDate").ToString())%>   
                                --%>
                            ...
                            <td class="simpletooltip left-bottom pastelblue" title="<%# getHasCollectDetail(Eval("collectId"))%>"
                                style="color: Blue">
                                <%# Eval("collectAmount")%>
                            </td>
                            <td>
                            ...
                            <td>
                                <%# Eval("collectStatus").ToString() =="完成收款"?"<font color='green'>完成收款</font>":(Eval("collectStatus").ToString()=="部分收款"?"<font color='blue'>部分收款</font>":"<font color='red'>未收款</font>") %>
                            </td>
                            <td>
                                <%# Eval("remark")%>
                            </td>
            ...
            <tr>
                ...
                <td id="adultNum" runat="server" style="color:Blue">
                </td>
                <td id="childNum" runat="server" style="color:Blue">
                </td>
                <td id="withNum" runat="server" style="color:Blue">
                </td>
