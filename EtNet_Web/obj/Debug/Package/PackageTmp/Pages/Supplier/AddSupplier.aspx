<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSupplier.aspx.cs" Inherits="EtNet_Web.Pages.Supplier.AddSupplier" %>
            ...
            <table class="dataBox">
                ...
                <tr>
                    ...
                    <td style="width: 26%;" align="left">
                        <input type="text" runat="server" id="factCode" class="clsunderline" /><span runat="server"
                ...
                <tr>
                    ...
                    <td align="left" colspan="3">
                        <input type="text" runat="server" id="cusCName" class="clsunderline" /><span
                            style="color: Red">*</span>
                    </td>
                </tr>
                <tr>
