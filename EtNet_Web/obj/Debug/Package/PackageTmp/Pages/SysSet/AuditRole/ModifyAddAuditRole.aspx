<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ModifyAddAuditRole.aspx.cs"
    Inherits="EtNet_Web.Pages.AuditRole.ModifyAddAuditRole" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#imgrefresh,#imgright,#imgleft,#imgup,#imgdown,#btnreset").click(function () {
                $("#teratxt").val(encodeURIComponent($("#teratxt").val()));
...
<body>
    ...
    <div class="clsbottom">
        ...
        <table class="clsdata">
            ...
            <tr>
              <td colspan="4" style=" color:blue;">审核流程图(目前系统只支持5级审批):</td>
            </tr>
            <tr>
                <td colspan="4">
