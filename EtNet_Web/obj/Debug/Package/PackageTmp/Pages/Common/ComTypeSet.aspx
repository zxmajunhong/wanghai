<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComTypeSet.aspx.cs" Inherits="EtNet_Web.Pages.Common.ComTypeSet" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#choose').click(function () {
            ...
            cusid.value = $.trim($('tr.selected').find('.comtypeid').html());
