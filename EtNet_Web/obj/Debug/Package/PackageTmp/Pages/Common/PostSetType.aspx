<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostSetType.aspx.cs" Inherits="EtNet_Web.Pages.Common.PostSetType" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#choose').click(function () {
            ...
            var postid = origin.document.getElementById('hidPostid');
            var postname = origin.document.getElementById('tbxPostid');

            postid.value = $.trim($('tr.selected').find('.postid').html());
            postname.value = $.trim($('tr.selected').find('.postName').html());
            art.dialog.close();
        });
...
<body>
    ...
    <div class="clsbottom">
        ...
        <table class="clsdata" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                <asp:Repeater runat="server" ID="post">
                    <ItemTemplate>
                        <tr>
                            <td>
