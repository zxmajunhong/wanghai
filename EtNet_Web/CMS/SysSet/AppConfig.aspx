<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppConfig.aspx.cs" Inherits="EtNet_Web.CMS.SysSet.AppConfig.AppConfig" %>
...
<body>
    ...
    <div id="man_zone">
        <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" class="table_style">
            <tr>
                <td colspan="2">
                    <asp:ImageButton ID="iBtnSave" runat="server" ImageUrl="../../Images/Button/btn_save.jpg" OnClick="iBtnSave_Click" />
                </td>
            </tr>
            <tr>
