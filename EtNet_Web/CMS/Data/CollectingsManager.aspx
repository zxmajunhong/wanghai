<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollectingsManager.aspx.cs"
    Inherits="EtNet_Web.CMS.Data.CollectingsManager" %>
            ...
            <tr>
                <td class="left_title_1" colspan="2">
                    <table cellpadding="0" cellspacing="1" border="0" id="table" style="width: 100%;">
                        ...
                        <tbody>
                            <asp:Repeater ID="rpCollecting" runat="server" OnItemCommand="rpCollecting_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <%# Eval("confirmReceipt").ToString()=="0"?"<font color='red'>未确认</font>":"已确认" %>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            ...
                            <th colspan="9" style="height: 27px;">
                                ...
                                <asp:ImageButton ID="ibtnDeleteAll" Style="display: none;" runat="server" CommandName="DeleteAll"
                                    Font-Size="12px" ImageUrl="../../Images/public/delete.gif" alt="删除"
                                    Width="16px" onclick="ibtnDeleteAll_Click"></asp:ImageButton>
