<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomersManager.aspx.cs"
    Inherits="EtNet_Web.CMS.Data.CustomersManager" %>
                            ...
                            <asp:Repeater ID="rpCustomer" runat="server" OnItemCommand="rpCustomer_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <%# Eval("cusPro").ToString().Trim() == "0" ? "潜在客户" : "正式客户"%>
                                        </td>
                                        <td>
                                            <%# Eval("used").ToString().Trim() == "0" ? "未启用" : "已启用"%>
                                        </td>
                                        <td>
                                            <%# cms_data_customersmanager_aspx.toMadeFrom(Convert.ToInt32( Eval("madefrom"))) %>
                                        </td>
                                        <td>
