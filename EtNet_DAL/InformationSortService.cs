...
namespace EtNet_DAL
{
    //InformationSortService
    public class InformationSortService
	{
   		     
		public static bool Exists(int id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from InformationSort");
			strSql.Append(" where ");
		    strSql.Append(" id = @id  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into InformationSort(");			
            strSql.Append("txt");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update InformationSort set ");                                           
		...
		public static bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from InformationSort ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
		...
		public static EtNet_Models.InformationSort GetModel(int id)
		{
			...
			strSql.Append("  from InformationSort ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
            ...
            EtNet_Models.InformationSort model = new EtNet_Models.InformationSort();
