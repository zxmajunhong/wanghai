...
{
	//AnnouncementStatus
	public partial class AnnouncementStatusService
	{
   		     
		public static bool Exists(int id)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select * from AnnouncementStatus");
			strSql.Append(" where ");
			strSql.Append(" id = @id  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into AnnouncementStatus(");			
            strSql.Append("txt");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update AnnouncementStatus set ");                                               
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from AnnouncementStatus ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
		...
		public static  EtNet_Models.AnnouncementStatus GetModel(int id)
		{
			...
			strSql.Append("  from AnnouncementStatus ");
			strSql.Append(" where id=@id");
						SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;

            EtNet_Models.AnnouncementStatus model = new EtNet_Models.AnnouncementStatus();
