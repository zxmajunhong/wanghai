...
{
	/// <summary>
	/// 数据访问类:StaffPapersSortService
	/// </summary>
	public  class StaffPapersSortService
	{
		public StaffPapersSortService()
		{}
		#region  Method
		...
		public static bool Exists(int id)
		{
			...
			strSql.Append("select * from StaffPapersSort");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into StaffPapersSort(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update StaffPapersSort set ");
		...
		public static bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from StaffPapersSort ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
		...
		public static EtNet_Models.StaffPapersSort GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,txt from StaffPapersSort ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;

            EtNet_Models.StaffPapersSort model = new EtNet_Models.StaffPapersSort();
		...
		public static DataTable GetList(string strWhere)
		{
			...
			strSql.Append(" FROM StaffPapersSort ");
			if(strWhere.Trim()!="")
			{
