...
namespace EtNet_BLL
{
    public class AusDetialInfoManager
    {
        ...
        {
            return EtNet_DAL.AusDetialInfoService.Updatebx(id, jobid, financetype);
        }
        ...
        /// 判断是否有跟进类型
        /// </summary>
        /// <param name="austype"></param>
        /// <returns></returns>
        public static int getAusDetialInfoByAusType(string austype)
        {
            return EtNet_DAL.AusDetialInfoService.getAusDetialInfoByAusType(austype);
        }
        /// <summary>
        ...
        {
            return EtNet_DAL.AusDetialInfoService.GetMonthCount(loginID, year);
        }
